...
class DonorBottom_navigation extends StatefulWidget {
  const DonorBottom_navigation({super.key});

  @override
  State<DonorBottom_navigation> createState() => _DonorBottom_navigationState();
}

class _DonorBottom_navigationState extends State<DonorBottom_navigation> {
              ...
              child: ClipRRect(
                ...
                child: BottomNavigationBar(
                  ...
                  selectedLabelStyle: GoogleFonts.roboto(
                      fontWeight: FontWeight.w600, fontSize: kTwelveFont),
